...
function udl(x1,x2,val,key){ return {type:'udl', x1:x1, x2:x2, val:val, key:key}; }
function pt(x,val,key){ return {type:'point', x:x, val:val, key:key}; }
function tri(x1,x2,dir,val,key){ return {type:'tri', x1:x1, x2:x2, dir:dir, val:val, key:key}; } // dir 'up'|'down' = which end is tall
...
// ---------------- SIMPLE BEAMS ----------------
{
  ...
  loads:p=>[udl(0,p.L,p.w,'w')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1}],
  totalLength:p=>p.L,
  calc(p){
    const {L,w}=p, R=w*L/2;
    const Vx=x=> w*(L/2-x);
...
},
{
  ...
  loads:p=>[udl(p.a,p.a+p.b,p.w,'w')],
  dims:p=>[{k:'a',x1:0,x2:p.a,row:0},{k:'b',x1:p.a,x2:p.a+p.b,row:0},{k:'c',x1:p.a+p.b,x2:p.a+p.b+p.c,row:0}],
...
},
{
  ...
  loads:p=>[udl(0,p.a,p.w,'w')],
  dims:p=>[{k:'a',x1:0,x2:p.a,row:0},{k:'c',x1:p.a,x2:p.a+p.c,row:0}],
...
},
{
  ...
  supports:p=>[pin(0),pin(p.a+p.b+p.c)],
  loads:p=>[udl(0,p.a,p.w1,'w1'),udl(p.a+p.b,p.a+p.b+p.c,p.w2,'w2')],
  dims:p=>[{k:'a',x1:0,x2:p.a,row:0},{k:'b',x1:p.a,x2:p.a+p.b,row:0},{k:'c',x1:p.a+p.b,x2:p.a+p.b+p.c,row:0}],
  totalLength:p=>p.a+p.b+p.c,
  calc(p){
...
},
{
  ...
  inputs:[{k:'L',l:'Span, L'},{k:'W',l:'Total load, W'}],
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[tri(0,p.L/2,'up',p.W,'W'),tri(p.L/2,p.L,'down',p.W,'W')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1}],
  totalLength:p=>p.L,
  calc(p){
    const {L,W}=p, R=W/2;
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[pt(p.a,p.P,'P')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:0,x2:p.a,row:0}],
  totalLength:p=>p.L,
  calc(p){
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[pt(p.a,p.P,'P'),pt(p.L-p.a,p.P,'P')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:0,x2:p.a,row:0}],
  totalLength:p=>p.L,
  calc(p){
    const {L,a,P}=p;
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[pt(p.a,p.P,'P'),pt(p.L-p.b,p.P,'P')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:0,x2:p.a,row:0},{k:'b',x1:p.L-p.b,x2:p.L,row:0}],
  totalLength:p=>p.L,
  calc(p){
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[pt(p.a,p.P1,'P1'),pt(p.L-p.b,p.P2,'P2')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:0,x2:p.a,row:0},{k:'b',x1:p.L-p.b,x2:p.L,row:0}],
  totalLength:p=>p.L,
  calc(p){
...
// ---------------- OVERHANGING BEAMS ----------------
{
  ...
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[udl(0,p.L+p.a,p.w,'w')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:p.L,x2:p.L+p.a,row:1}],
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L)],
  loads:p=>[pt(p.a,p.P,'P')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:0,x2:p.a,row:0},{k:'ov',x1:p.L,x2:p.L+(p.ov||0),row:1}],
...
},
{
  ...
  loads:p=>[udl(0,p.a+p.b+p.c,p.w,'w')],
  dims:p=>[{k:'a',x1:0,x2:p.a,row:0},{k:'b',x1:p.a,x2:p.a+p.b,row:0},{k:'c',x1:p.a+p.b,x2:p.a+p.b+p.c,row:0}],
  totalLength:p=>p.a+p.b+p.c,
  calc(p){
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L),pin(2*p.L)],
  loads:p=>[pt(p.a,p.P,'P'),pt(2*p.L-p.a,p.P,'P')],
  dims:p=>[{k:'L',x1:0,x2:p.L,row:1},{k:'a',x1:0,x2:p.a,row:0}],
  totalLength:p=>2*p.L,
  calc(p){
...
},
{
  ...
  loads:p=>[udl(0,p.L1+p.L2,p.w,'w')],
  dims:p=>[{k:'L1',x1:0,x2:p.L1,row:0},{k:'L2',x1:p.L1,x2:p.L1+p.L2,row:0}],
...
},
{
  ...
  supports:p=>[pin(0),pin(p.L1),pin(p.L1+p.L2)],
  loads:p=>[pt(p.L1/2,p.P1,'P1'),pt(p.L1+p.L2/2,p.P2,'P2')],
  dims:p=>[{k:'L1',x1:0,x2:p.L1,row:0},{k:'L2',x1:p.L1,x2:p.L1+p.L2,row:0}],
  totalLength:p=>p.L1+p.L2,
  calc(p){
